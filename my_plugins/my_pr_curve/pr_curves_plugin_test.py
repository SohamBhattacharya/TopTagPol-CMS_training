...
# ==============================================================================
"""Integration tests for the my_pr_curves plugin."""
...
from my_pr_curve import pr_curve_demo
from my_pr_curve import pr_curves_plugin
...
class PrCurvesPluginTest(tf.test.TestCase):
    ...
    def testRoutesProvided(self):
        ...
        self.assertIsInstance(routes["/my_pr_curves"], collections.abc.Callable)
    ...
    def testTagsProvided(self):
        ...
        self.assertItemsEqual(
            ["red/my_pr_curves", "green/my_pr_curves", "blue/my_pr_curves"],
        ...
        self.assertDictEqual(
            ...
            tags_response["colors"]["red/my_pr_curves"],
        )
        self.assertDictEqual(
            {
            ...
            tags_response["colors"]["green/my_pr_curves"],
        )
        self.assertDictEqual(
            {
            ...
            tags_response["colors"]["blue/my_pr_curves"],
        )
        self.assertDictEqual(
            {
                "displayName": "classifying red",
            ...
            tags_response["mask_every_other_prediction"]["red/my_pr_curves"],
        )
        self.assertDictEqual(
            {
                "displayName": "classifying green",
            ...
            tags_response["mask_every_other_prediction"]["green/my_pr_curves"],
        )
        self.assertDictEqual(
            {
                "displayName": "classifying blue",
            ...
            tags_response["mask_every_other_prediction"]["blue/my_pr_curves"],
        )
