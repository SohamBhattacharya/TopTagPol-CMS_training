...
# ==============================================================================
"""Internal information about the my_pr_curves plugin."""


from tensorboard.compat.proto import summary_pb2
from tensorboard.plugins.pr_curve import plugin_data_pb2

PLUGIN_NAME = "my_pr_curves"
...
def create_summary_metadata(display_name, description, num_thresholds):
    """Create a `summary_pb2.SummaryMetadata` proto for my_pr_curves plugin data.
...
def parse_plugin_metadata(content):
    ...
    Arguments:
      content: The `content` field of a `SummaryMetadata` proto
        corresponding to the my_pr_curves plugin.
