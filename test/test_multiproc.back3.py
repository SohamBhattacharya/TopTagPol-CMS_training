...
class TrainingData :
    ...
    def __init__(
        ...
        self.arr_idx = np.ndarray(arr_idx.shape, dtype = arr_idx.dtype, buffer = self.arr_idx_shared.buf)
        self.arr_val = np.ndarray(arr_val.shape, dtype = arr_val.dtype, buffer = self.arr_val_shared.buf)
...
def computeBins(
    ...
    arr_idx_shared[fill_start: fill_end] = arr_idx_temp
    arr_val_shared[fill_start: fill_end] = arr_val_temp
